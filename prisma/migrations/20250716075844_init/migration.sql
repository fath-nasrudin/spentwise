...
-- CreateEnum
CREATE TYPE "BudgetType" AS ENUM ('BUDGET', 'GOAL');
...
CREATE TABLE "budgets" (
    ...
    "type" "BudgetType" NOT NULL DEFAULT 'BUDGET',
...
-- AddForeignKey
ALTER TABLE "budgets" ADD CONSTRAINT "budgets_walletId_fkey" FOREIGN KEY ("walletId") REFERENCES "Wallet"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "budget_categories" ADD CONSTRAINT "budget_categories_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
